      ...
      <main className="[font-family:'Neue_Haas_Grotesk_Display_Pro'] mt-[var(--CALC_FIRST_HEADER_HEIGHT)]">
        ...
        <div className="bg-background_reverse max-mxl:px-3 py-10">
          <TextReveal classes="px-6">
            <p className="text-center text-[1.75rem] md:text-[3rem] font-medium text-white">
        ...
        <section>
          <div className="bg-green py-12 md:py-10 mxl:py-20 sticky top-0 z-10 flex justify-center items-start">
            ...
            <div className="mxl:basis-[65%] max-mxl:px-8 space-y-4 overflow-hidden ">
              <div className="2xl:translate-x-[60px] md:hidden overflow-hidden max-w-full">
                <TextReveal classes="">
                  <p className="text-secondary_yellow leading-[200%] font-normal text-[16px] md:text-[17px] ">
                    Even top companies like Amazon, Flipkart,{" "}
                  </p>
                  <p className="text-secondary_yellow leading-[200%] font-normal text-[16px] md:text-[17px] ">
                    UKG, and Meesho have unknowingly{" "}
                  </p>
                  <p className="text-secondary_yellow leading-[200%] font-normal text-[16px] mxl:text-[17px] ">
                    shortlisted or extended offers to those
                  </p>
                  <p className="text-secondary_yellow leading-[200%] font-normal text-[16px] mxl:text-[17px] ">
                    students who cheated in the OA rounds,{" "}
                  </p>
                  <p className="text-secondary_yellow leading-[200%] font-normal text-[16px] mxl:text-[17px] ">
                    {" "}
                    compromising theintegrity of their{" "}
                  </p>
                  <p className="text-secondary_yellow leading-[200%] font-normal text-[16px] mxl:text-[17px] ">
                    hiring process.
                  </p>
              ...
              <div className="2xl:translate-x-[60px] max-md:hidden overflow-hidden max-w-full">
                <TextReveal classes="">
                  <p className="text-secondary_yellow  font-normal text-[14px] md:text-[17px] ">
              ...
              <div className="mxl:basis-[30%] md:px-10 px-5 bg-background2 flex justify-center  py-20">
                <div className="mxl:hidden">
                  <TextReveal classes="space-y-4">
                    <p className="text-[#02313E] font-normal text-[1.125rem] tracking-wide">
                      Recent cases across top companies
                    </p>
                    <p className="text-[#02313E] font-normal text-[1.125rem] tracking-wide">
                      hiring cycles reveal a disturbing{" "}
                    </p>
                    <p className="text-[#02313E] font-normal text-[1.125rem] tracking-wide">
                      pattern
                    </p>
                ...
                <div className="max-mxl:hidden">
                  <TextReveal classes="space-y-4">
                    <p className="text-[#02313E] font-normal text-[1.375rem] tracking-wide">
                      Recent cases across
                    </p>
                    <p className="text-[#02313E] font-normal text-[1.375rem] tracking-wide">
          ...
          <div className="relative ">
            ...
            <div className="absolute bottom-0  flex w-full justify-center">
              <div className="max-md:translate-y-[137px] mxl:translate-x-[137px] max-mxl:w-full  md:[clip-path:polygon(0px_0px,100%_0px,100%_100%,50%_100%,30%_calc(100%-3.71429px-6.95238vw),0px_calc(100%-3.71429px-6.95238vw))] bg-gradient-to-r backdrop-blur-[70px] from-[#004051] to-[#6B6969]">
                ...
                <div>
                  <div className="md:hidden py-5 mxl:py-10 px-5 mxl:px-20 mxl:pr-60 space-y-4 ">
                  ...
                  <div className="max-md:hidden py-5 mxl:py-10 px-5 mxl:px-20 mxl:pr-60 space-y-4 ">
                    <TextReveal classes=" max-md::hidden">
                      <p className="text-white/[.9] font-normal text-[2.25rem] ">
                  ...
                  <div className="flex justify-end max-mxl:mt-8">
                    <div className="w-max space-y-4 md:hidden  py-5 mxl:py-10 px-8 mxl:px-16">
                      <TextReveal classes="">
                    ...
                    <div className="w-max max-md:hidden space-y-4 pb-16 py-5 mxl:py-10 px-8 mxl:px-16">
                      <TextReveal classes="">
                        <p className="font-normal text-[1.125rem] text-white">
        ...
        <div className=" grid 2xl:grid-cols-[120px_12fr_1.5fr] 4k:grid-cols-[160px_12fr_1.5fr] mxl:grid-cols-[1fr_12fr_1.5fr] grid-cols-1">
          ...
          <div className="min-w-0 max-mxl:px-5 border-l-2 bg-secondary_blue border-grey-almost/[.3] max-md:pt-44 py-16 mxl:py-28 2xl:py-32 flex justify-end">
            <div className="text-white mxl:hidden font-normal text-[1.5rem] space-y-4 ">
              <p className=" ">
            ...
            <div className="text-white max-mxl:hidden font-normal text-[1.5rem] space-y-4 ">
              <TextReveal classes="">
                <p className=" ">
        ...
        <div className=" grid min-h-[326px] 2xl:min-h-[423px] 2xl:grid-cols-[120px_12fr] 4k:grid-cols-[160px_12fr] mxl:grid-cols-[1fr_13.5fr] grid-cols-1">
          ...
          <div className="min-w-0 bg-blue grid grid-cols-1 md:grid-cols-2">
            <div className="flex justify-center">
              <div className="font-normal mt-[14%] mxl:hidden px-5 text-[1rem] text-white space-y-5">
                <TextReveal classes="">
                  <p>
              ...
              <div className="font-normal mt-[14%] max-mxl:hidden px-5 text-[1rem] text-white space-y-5">
                <TextReveal classes="">
                  <p>As a result, hundreds — sometimes thousands — of </p>
                  <p>students are able to bypass genuine skill evaluations, </p>
            ...
            <div className="flex mxl:border-l-2 mxl:border-white max-md:pb-12 justify-center">
              <div className="font-normal mxl:hidden mt-[14%] px-5 mb-[5%]  text-[1rem] text-white space-y-5">
                <TextReveal classes="">
                  <p>
                    Beyond simply accessing leaked questions, many students now
                    submit codes directly copied from Telegram groups or seek
                    paid OA help services to clear assessments — further eroding
                    the credibility of the hiring process.
                  </p>
                </TextReveal>
              </div>
              <div className="font-normal max-mxl:hidden mt-[14%] px-5 mb-[5%]  text-[1rem] text-white space-y-5">
                <TextReveal classes="">
